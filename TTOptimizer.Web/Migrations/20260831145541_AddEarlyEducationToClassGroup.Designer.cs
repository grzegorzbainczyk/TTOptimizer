...
namespace TTOptimizer.Web.Migrations
{
    ...
    [Migration("20260831145541_AddEarlyEducationToClassGroup")]
    partial class AddEarlyEducationToClassGroup
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClassGroup", b =>
                {
                    ...
                    b.Property<bool>("IsEarlyEducation")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("TTOptimizer.Web.Models.Domain.SchoolUnit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TTOptimizer.Web.Models.Domain.TeacherAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("OrganizationId", "TeacherId", "SubjectId", "ClassGroupId")
                        .IsUnique();
            ...
            modelBuilder.Entity("ClassGroup", b =>
                {
                    ...
                    b.HasOne("TTOptimizer.Web.Models.Domain.SchoolUnit", "SchoolUnit")
                        .WithMany("ClassGroups")
