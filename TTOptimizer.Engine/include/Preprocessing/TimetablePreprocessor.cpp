...
#include "Preprocessing/AvailabilityValidator.h"
#include "Preprocessing/ReferenceIntegrityValidator.h"
#include "Preprocessing/StructuralProblemValidator.h"

namespace
{
    void AppendIssues(
        std::vector<PreprocessingIssue>& destination,
        std::vector<PreprocessingIssue> source)
    {
        destination.insert(
            destination.end(),
...
PreprocessingResult TimetablePreprocessor::process(
