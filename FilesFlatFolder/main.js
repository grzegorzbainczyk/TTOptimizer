...
import { initializeSchoolReadiness } from "./main/school-readiness.js";
import { initializeAuthSession } from "./main/auth-session.js";

document.addEventListener("DOMContentLoaded", async () => {
    if (!initializeAuthSession()) {
        return;
    }
    ...
    try {
        await initializeSchoolReadiness();
    } catch (error) {
        console.error("Could not initialize school readiness:", error);
    }
